...
def parse_args():
    ...
    parser.add_argument(
        "--train-data",
        type=str,
        default=f'{parent_dir}/VG_data/our_train_augment_dataset.csv',  # 우리 데이터셋 경로
        help="Path to csv file with training data",
    )
    parser.add_argument(
        "--val-data",
        type=str,
        default=f'{parent_dir}/VG_data/val_with_cap.csv',   # 우리 데이터셋 경로
    ...
    parser.add_argument(
        "--save_eval_model", default=True, action="store_true", help="save_eval_model"
    )
