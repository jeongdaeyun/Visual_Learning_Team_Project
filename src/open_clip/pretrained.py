...
_RN50 = dict(
    openai=_pcfg(
    "https://openaipublic.azureedge.net/clip/models/afeb0e10f9e5a86da6080e35cf09123aca3b358a0c3e3b6c78a7b63bc04b6762/RN50.pt"  # "/home/sliver/daeyun/RegionCLIP/pretrained_ckpt/regionclip/regionclip_pretrained-cc_rn50.pth"
...
_RN50_R = dict(
    openai=_pcfg(
    "/home/sliver/daeyun/RegionCLIP/pretrained_ckpt/regionclip/regionclip_pretrained-cc_rn50.pth"  
...
def get_pretrained_cfg(model: str, tag: str):
    if model not in _PRETRAINED:             #### 위에서 _PRETRAINED 파트에 우리 모델 추가 필요할 것 같음
        return {}
    model_pretrained = _PRETRAINED[model]
    return model_pretrained.get(tag.lower(), {})   #### model의 tag에 해당하는 pcfg(링크)에 대한 값 반환
